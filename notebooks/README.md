...
| 06 | [African Air Quality with AirQo](06_african_air_quality.ipynb) | `AIRQO_API_KEY` | Researcher, Student (outputs cleared 2026-09-22 pending a renewed AirQo token) |
| 07 | [Global Sensor Network Comparison](07_global_sensor_comparison.ipynb) | `PURPLEAIR_API_KEY`, `AIRQO_API_KEY` | Researcher, IoT Developer (executed 2026-09-22 with the AirQo token expired, so its AirQo column is empty) |
| 08 | [Multi-Year Trend Analysis](08_trend_analysis.ipynb) | None | Researcher, Consultant |

Outputs last executed live on 2026-09-22 with aeolus 0.5.0a1 (notebook 06 excepted, see above).
