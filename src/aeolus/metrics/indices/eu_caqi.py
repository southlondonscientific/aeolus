...
def calculate(
    ...
    # A missing (NaN) reading is "unknown" — not the worst band. A NaN fails
    # every breakpoint comparison, so without this guard it would return None
    # and the out-of-range path below reports the worst category.
